    ...
    private:
                ...
                muduo::Timestamp timestamp)
        {
            ...
            while(true) {
                ...
                if (tHeader.type() == DdKd::KDMsgTypeLocPoint ) {
                    ...
                    DdKd::KDLocationInfo loc_info;
                    if(!loc_info.ParseFromArray(tReq.payload().c_str(), tReq.payload().length())){
                    ...
                    //    }
                    //}
                    CINFO_LOG("%ld %.6f %.6f %.3f %d %ld %ld %.6f", loc_info.driverid(), 
                            loc_info.lat(),
                            loc_info.lng(),
                            loc_info.spd(),
                            loc_info.work(),
                            loc_info.location_timestamp(),
                            loc_info.location_type(),
                            loc_info.direction() );
