...
REPLACE(REPLACE(REPLACE(pinyin_s,'\r',''),'\n',''),'||','') AS pinyin_s,\
type,\
area,\
REPLACE(REPLACE(REPLACE(district,'\r',''),'\n',''),'||','') AS district,\
REPLACE(REPLACE(REPLACE(legal_name,'\r',''),'\n',''),'||','') AS legal_name,\
REPLACE(REPLACE(REPLACE(legal_id_card,'\r',''),'\n',''),'||','') AS legal_id_card,\
REPLACE(REPLACE(REPLACE(legal_phone,'\r',''),'\n',''),'||','') AS legal_phone,\
REPLACE(REPLACE(REPLACE(contact,'\r',''),'\n',''),'||','') AS contact,\
REPLACE(REPLACE(REPLACE(contact_phone,'\r',''),'\n',''),'||','') AS contact_phone,\
REPLACE(REPLACE(REPLACE(address,'\r',''),'\n',''),'||','') AS address,\
REPLACE(REPLACE(REPLACE(business_license,'\r',''),'\n',''),'||','') AS business_license,\
license_valid_date,\
tax_point,\
current_driver_num,\
current_car_num,\
...
_status \
FROM g_company WHERE \$CONDITIONS"
