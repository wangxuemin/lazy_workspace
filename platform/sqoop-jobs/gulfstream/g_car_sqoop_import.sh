...
level,\
REPLACE(REPLACE(REPLACE(brand,'\r',''),'\n',''),'||','') AS brand,\
REPLACE(REPLACE(REPLACE(color,'\r',''),'\n',''),'||','') AS color,\
REPLACE(REPLACE(REPLACE(delivery,'\r',''),'\n',''),'||','') AS delivery,\
operate_qualify,\
seat_num,\
...
ext_verify_status,\
channel,\
REPLACE(REPLACE(REPLACE(check_code,'\r',''),'\n',''),'||','') AS check_code,\
REPLACE(REPLACE(REPLACE(check_value,'\r',''),'\n',''),'||','') AS check_value,\
car_channel,\
