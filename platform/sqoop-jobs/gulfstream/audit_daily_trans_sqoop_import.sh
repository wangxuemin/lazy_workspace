...
unfreeze_amount,\
daily_balance,\
daily_freeze_balance,\
total_balance,\
total_freeze_balance,\
...
FROM audit_daily_trans_${y}${m} WHERE _create_time BETWEEN '$v_executeDate 00:00:00' AND '$v_executeDate 23:59:59' AND \$CONDITIONS"
