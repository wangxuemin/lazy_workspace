#function description: regCnt(today regist cnt)
#procedure name: P_DM_passengernottodayreg
#creator:MARS
#created:
#!/bin/bash
#today date
...
#) 
#insert recorders from pdw.PassengerZipper  to APP.passengerNOTtodayreg
/home/xiaoju/hive-0.10.0/bin/hive -e 	"use APP;
INSERT OVERWRITE TABLE PASSENGERNOTTODAYREG PARTITION(YEAR='$V_PARYEAR',MONTH='$V_PARMONTH',DAY='$V_PARDAY')
SELECT 0,
	   '$V_YESTERDAY',
	   M.AREA,
	   M.CHANNEL,
...
;"
/home/xiaoju/hadoop-1.0.4/bin/hadoop fs -touchz /user/xiaoju/data/bi/app/passengernottodayreg/$V_PARYEAR/$V_PARMONTH/$V_PARDAY/_SUCCESS