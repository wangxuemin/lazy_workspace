...
#procedure name: P_DM_driverregperiod3weeks
#creator:MARS
#created:
#!/bin/bash
#today date
...
# $fromDat=$this->threeWeeks
# $toDat=$this->today
/home/xiaoju/hive-0.10.0/bin/hive -e "use app;
INSERT OVERWRITE TABLE DRIVERREGPERIOD3WEEKS PARTITION(YEAR='$V_PARYEAR',MONTH='$V_PARMONTH',DAY='$V_PARDAY')
SELECT 0,
       '$V_YESTERDAY',
	   M.AREA,
	   M.CHANNEL,
...
;"
/home/xiaoju/hadoop-1.0.4/bin/hadoop fs -touchz /user/xiaoju/data/bi/app/driverregperiod3weeks/$V_PARYEAR/$V_PARMONTH/$V_PARDAY/_SUCCESS	