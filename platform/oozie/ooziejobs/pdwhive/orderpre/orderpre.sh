...
INSERT OVERWRITE TABLE ORDERPRE PARTITION(YEAR='$V_PARYEAR',MONTH='$V_PARMONTH',DAY='$V_PARDAY')
SELECT 0,
		'$V_YESTERDAY',
		M.AREA,
		M.CHANNEL,
...
;"
/home/xiaoju/hadoop-1.0.4/bin/hadoop fs -touchz /user/xiaoju/data/bi/app/orderpre/$V_PARYEAR/$V_PARMONTH/$V_PARDAY/_SUCCESS