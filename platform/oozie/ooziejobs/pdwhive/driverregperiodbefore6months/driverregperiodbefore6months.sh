...
#procedure name: p_dm_driverregperiodbefore6months
#creator:MARS
#created:
#!/bin/bash
#today date
...
# $toDate=$this->sixMonths
/home/xiaoju/hive-0.10.0/bin/hive -e "use app;
INSERT OVERWRITE TABLE DRIVERREGPERIODBEFORE6MONTHS PARTITION(YEAR='$V_PARYEAR',MONTH='$V_PARMONTH',DAY='$V_PARDAY')
SELECT 0,
       '$V_YESTERDAY',
	   M.AREA,
	   M.CHANNEL,
...
ON (M.AREA = B.AREA AND M.CHANNEL = B.CHANNEL)
	;"
/home/xiaoju/hadoop-1.0.4/bin/hadoop fs -touchz /user/xiaoju/data/bi/app/driverregperiodbefore6months/$V_PARYEAR/$V_PARMONTH/$V_PARDAY/_SUCCESS	